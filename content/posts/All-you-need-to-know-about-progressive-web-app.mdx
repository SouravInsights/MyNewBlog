...
![](https://cdn-images-1.medium.com/max/1000/1*kSZwLF-4W2DleUByUPPFvw.jpeg)
...
Now let’s talk about the “*WHY”. *Why [Frances
...
![](https://cdn-images-1.medium.com/max/1000/1*Vnkijr5zdXM87DY7q40VQg.png)
...
![](https://cdn-images-1.medium.com/max/1000/1*e7xxOa3_1AoK5-qg6ryrAQ.png)
...
![](https://cdn-images-1.medium.com/max/1000/1*m1oKttWs-JKCVPx0SoB1fA.png)
...
![](https://cdn-images-1.medium.com/max/1000/1*m3qE6n7UfdA4BED8lNegKg.png)
...
- [The Weather
  Channel](https://developers.google.com/web/showcase/2016/weather-channel)
...
![](https://cdn-images-1.medium.com/max/1000/1*BKMiowEBMrLDyTfbqcwfqg.png)
...
![](https://cdn-images-1.medium.com/max/1000/1*LpvtFH3hIbPpJ9e4xRpMbg.png)
...
how to improve it.<br> Once installed open up your website and click on the
Lighthouse icon in the top right of your browser then Generate Report.

![](https://cdn-images-1.medium.com/max/1000/1*1jPywRVAHcebZeUIyPMllQ.png)
...
![](https://cdn-images-1.medium.com/max/1000/1*GwBZgjItyjEwaaZn-lxTTA.png)
...
> author, icon, and description) in a JSON text file. The purpose of the manifest
> is to install web applications to the homescreen of a device, providing users
...
![](https://cdn-images-1.medium.com/max/1000/1*5LM7_X9cAfH51oyX2aB59g.png)

Now you have a manifest that was created by the icon generator tool, but we’re
going to add a little bit more to it.<br> Head over to a [web app manifest
